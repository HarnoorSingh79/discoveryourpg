...
<head>
  ...
  <title>Single room in amritsar | Discoveryourpg </title>
...
<body>
  <div class="dabba">
    ...
    <br> <br>
    <form method="POST" action="./singleroom2.php">
        ...
        <label for="in5">Location you want single room in?<em>&#x2a;</em></label>
        <input id="in5" name="in5" type="text" required />
        ...
        <textarea id="in7" name="in7" value="<?php echo $query;?>" rows="4" required placeholder="If you are students let us know where you study"></textarea>
        <h3>We need to tell portion onwer about you before we can schedule your visit</h3>
