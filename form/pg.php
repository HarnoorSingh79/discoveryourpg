...
<body>
  <div class="dabba">
    ...
    <form method="POST" action="./pg2.php">
        ...
        <label for="in10">Type of Pg you want?<em>&#x2a;</em></label>
        <select id="in10" name="in10" class="myselect">
            <option value="boy">Boys</option>
            <option value="girls">Girls</option>
            <option value="unisex">Unisex</option>
        </select>
        
        <label for="in4">Are you ok with sharing?<em>&#x2a;</em></label>
        <select id="in4" name="in4" class="myselect">
            <option value="sharing">Yes, i am okay with it!</option>
            <option value="single room">No, I want room to myself!</option>
        </select>

        <label for="in5">Location you want pg in?<em>&#x2a;</em></label>
