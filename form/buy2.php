...
mobile = $in2
From = $in3
Location they buy property in = $in4 (if empty, it means they are not sure)
...
$subject = "Someone wannt to buy property";
$message = $msg;
$headers = "From:" . $from;
...
<head>
    ...
    <title>Buy property Form done | Discoveryourpg </title>
