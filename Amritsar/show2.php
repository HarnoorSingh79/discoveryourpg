...
<div class="sec3">
    ...
    <div id="myBtnContainer">
        ...
        <button class="btn <?php echo $gndu?>" onclick="filterSelection('near gndu')"> Near Gndu</button>
        <button class="btn <?php echo $khalsa?>" onclick="filterSelection('near khalsa college')"> Near khalsa college</button>
    </div>
