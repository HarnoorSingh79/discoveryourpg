    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($password!=$repassword){
            ...
            if(strlen($password)<8){
                ...
                mysqli_query($link,"INSERT INTO 1_user(username,email,password,types) 
                VALUES('$username','$email','$password','$types')");
...
<body style="padding: 40px;">
    <form class="form-register"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="username" id="username" aria-describedby="emailHelp" placeholder="Your name" required>
        </div>

        <div class="form-group">
            <label>Mobile Number</label>
            <input type="tel" class="form-control" name="Email" id="Email" placeholder="Your mobile number" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select id="types" name="types" id="types" class="form-control">
